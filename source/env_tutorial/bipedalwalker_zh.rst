...
在这种环境下，Agent控制机器人前进以获得奖励。如果成功移动到最远端将累积获取300+积分;如果机器人摔倒，积分扣减100分。应用电机扭矩会消耗少量点数，最优代理越多将会获得越高的积分。
...
-  前进有奖励，到达远端需要累积大概300积分。 如果机器人摔倒，Agent将被扣除100积分。每个动作都会扣除少量积分，奖励是一个\ ``float``\ 数值，范围[-400, 300]
